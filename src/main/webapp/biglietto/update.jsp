			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form method="post" action="ExecuteUpdateBigliettoServlet" class="row g-3" novalidate="novalidate">
								...
								<!--<c:set var = "bigliettoInPagina" value = "${bigliettoDaInviareAdUpdate}"/> -->
								...
								<div class="col-md-6">
									...
									<input type="text" name="provenienza" id="provenienza" class="form-control" placeholder="Inserire la provenienza"  
										value="${bigliettoDaInviareAdUpdate.provenienza!=null?bigliettoDaInviareAdUpdate.provenienza:''}" required>
								</div>
								...
								<div class="col-md-6">
									...
									<input type="text" name="destinazione" id="destinazione" class="form-control" placeholder="Inserire la destinazione"  
										value="${bigliettoDaInviareAdUpdate.destinazione!=null?bigliettoDaInviareAdUpdate.destinazione:''}" required>
								</div>
							
								<div class="col-md-6">
									<label for="prezzo" class="form-label">Prezzo <span class="text-danger">*</span></label>
									<input type="number" class="form-control" name="prezzo" id="prezzo" placeholder="Inserire prezzo" 
									value="${bigliettoDaInviareAdUpdate.prezzo!=null?bigliettoDaInviareAdUpdate.prezzo:''}" required>
								</div>
								
								<fmt:formatDate pattern="yyyy-MM-dd" value="${bigliettoDaInviareAdUpdate.data}" var="dataParsed"/> 
								<div class="col-md-3">
